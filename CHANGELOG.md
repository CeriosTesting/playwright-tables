...
- 292436d: Improve header key readability when using header sanitization by normalizing line-ending and control whitespace variants to single spaces when `normalizeWhitespace` is enabled.
